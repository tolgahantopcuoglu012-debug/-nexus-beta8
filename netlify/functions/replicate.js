const REPLICATE_KEY = process.env.REPLICATE_API_KEY || 'r8_eLz9fi6Qy398aFnpNp0KRzKt000LNyY3AbYJD';
...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (body.action === 'download') {
      ...
      return { statusCode: 200, headers: { ...CORS, 'Content-Type': 'application/octet-stream' }, body: base64, isBase64Encoded: true };
    }
